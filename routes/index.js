...
router.get('/', function (req, res) {
  res.render('index', { title: 'Creature App', user : req.user });
});
router.get('/register', function(req, res) {
  res.render('register', { title: 'Creature App Registration'});
});
...
router.get('/login', function(req, res) {
    res.render('login', { title: 'Creature App Login', user : req.user });
  });
